...
router.get('/findHallPriceDetails', asyncHandler(getHallPriceDetails), price);
router.post('/updatePriceDetails', asyncHandler(updatePriceDetails), msg);


async function getHallPriceDetails(req, res, next) {
    const price = req.body;
    const priceDetails = await priceController.getHallPriceDetails();
